...
public class EntityMagicBoat extends Entity
{
    ...
    public EntityMagicBoat(World par1World)
    {
        super(par1World);
        this.field_70279_a = true;
        this.speedMultiplier = 0.11D;
        this.preventEntitySpawning = true;
        this.setSize(2.3F, 0.9F);
    ...
    public EntityMagicBoat(World par1World, double par2, double par4, double par6)
    {
        this(par1World);
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2)
    {
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            if (flag || this.getDamageTaken() > 400.0F)
            {
                ...
                if (!flag)
                {
                    this.dropItemWithOffset(mod_MagicTree.Magicboat.itemID, 1, 0.0F);
                }
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    for (l = 0; l < list.size(); ++l)
                    {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof EntityMagicBoat)
                        {
