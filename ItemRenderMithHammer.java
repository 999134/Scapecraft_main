...
public class ItemRenderMithHammer implements IItemRenderer {

	protected ModelWarhammer WarHammerModel ;
	
	public ItemRenderMithHammer(){
	...
	case  ENTITY:
    {
        ...
        //FMLClientHandler.instance().getClient().renderEngine.bindTexture("/mods/whip.png");
	       Minecraft.getMinecraft().renderEngine.bindTexture(Resources.TEXTURE_MithHammer);
