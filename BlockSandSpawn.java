...
public class BlockSandSpawn extends Block
{
    public BlockSandSpawn(int i, int j)
    {
...
//@Override
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        public int tickRate(World par1World){return 20*2;}
    ...
    
    {
    	...
    	this.blockIcon = iconRegister.registerIcon("sand");
                     for (int N = 0; N < 2; N++)
                     {
                                     this.Texture[0] = iconRegister.registerIcon("sand");
