...
public class EntityBandit extends EntityMob {
	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		if (quickvar1 <= 1) {
			entityDropItem(new ItemStack(mod_phat.blackgLeggings), 1);
		}
		if (quickvar2 <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.keris), 1);
		}
		if (quickvar3 <= 2) {
			entityDropItem(new ItemStack(mod_Flower.fishpie), 3);
		}
		if (quickvar4 <= 1) {
		...
		if (quickvar10 <= 1) {
			entityDropItem(new ItemStack(Block.coalBlock), 1);
		}
		if (quickvar7 <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.Addysword), 1);
		}
		if (quickvar8 <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.AddyHammer), 1);
		}
		if (quickvar9 <= 1) {
