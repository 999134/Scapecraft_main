...
public class EntityShopKeeper extends EntityMob
{
...
protected String getLivingSound()
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
  	  ...
  	  if(!worldObj.isRemote) {	ModLoader.getMinecraftInstance().thePlayer.addChatMessage("\u00a7EShopKeeper: Please look around the shop! Right click to buy an item");}}}
