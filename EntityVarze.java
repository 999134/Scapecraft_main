...
public class EntityVarze extends EntityMob
{
...
protected String getLivingSound()
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
    	...
    	if (itemstack != null && itemstack.itemID == mod_Flower.InvincibilityPotion.itemID)
        {
            if (itemstack.stackSize-- == 1)
            {
                par1EntityPlayer.inventory.setInventorySlotContents(par1EntityPlayer.inventory.currentItem, new ItemStack(mod_Flower.RewardChest));
                if(!worldObj.isRemote) {    par1EntityPlayer.addChatMessage("\u00a7ESir Amik Varze: Thanks for your help! Take this treasure chest as a reward.");
                }
            }
            else if (!par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_Flower.RewardChest)))
            {
                par1EntityPlayer.dropPlayerItem(new ItemStack(mod_Flower.RewardChest.itemID, 1, 0));
            }
            ...
            return true;
    		  ...
    		  if(!worldObj.isRemote) {par1EntityPlayer.addChatMessage("\u00a7ESir Amik Varze: Please investisgate the Black Knights Fortress north of here, I need you to steal their invincibility potion");
    		  }
    ...
    public void func_82163_bD()
    {
    	 ...
    	 this.setCanPickUpLoot(this.rand.nextFloat() < equipmentDropChances[this.worldObj.difficultySetting]);
    	   if (this.getCurrentItemOrArmor(4) == null){
            ...
            this.setCurrentItemOrArmor(3, new ItemStack(mod_phat.whiteChestplate));
 ...
 static
         {
                 defaultHeldItem = new ItemStack(mod_BlocksGalore.Whitesword, 1);
         }
