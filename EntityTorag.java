...
public class EntityTorag extends EntityMob {
	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		if (quickvar <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.ToragHammer), 1);
		}
		if (quickvar1 <= 1) {
			entityDropItem(new ItemStack(mod_phat.dragonLeggings), 1);
		}
		if (quickvar2 <= 1) {
			entityDropItem(new ItemStack(mod_phat.ToragLeggings), 1);
		}
		if (quickvar3 <= 1) {
			entityDropItem(new ItemStack(mod_phat.ToragBoots), 1);
		}
		if (quickvar4 <= 1) {
			entityDropItem(new ItemStack(mod_phat.ToragHelmet), 1);
		}
		if (quickvar5 <= 1) {
			entityDropItem(new ItemStack(mod_phat.ToragChestplate), 1);
		}
		if (quickvar6 <= 1) {
			entityDropItem(new ItemStack(mod_Flower.ToragKey), 1);
		}
