...
public class EntityHeroKnight extends EntityMob
{
...
if(quickvar5 <= 1){
	...
	entityDropItem(new ItemStack(Item.goldNugget), 2);
...
int XP1 = rand.nextInt(1) + 1;if(XP <= 1){entityDropItem(new ItemStack(mod_Flower.XPORB), 1);}
 ...
 static
         {
                 defaultHeldItem = new ItemStack(mod_BlocksGalore.SGS, 1);
         }
 ...
 public boolean interact(EntityPlayer par1EntityPlayer)
 {
 	...
 	ModLoader.getMinecraftInstance().thePlayer.addChatMessage("\u00a7EHero White Knight: Show me to the fight");}}
