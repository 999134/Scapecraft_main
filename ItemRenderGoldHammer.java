...
public class ItemRenderGoldHammer implements IItemRenderer {

	protected ModelWarhammer WarHammerModel ;
	
	public ItemRenderGoldHammer(){
	...
	case  ENTITY:
    {
        ...
        GL11.glScalef(scale,scale,scale);
	       Minecraft.getMinecraft().renderEngine.bindTexture(Resources.TEXTURE_GoldHammer);
