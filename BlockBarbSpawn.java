...
public class BlockBarbSpawn extends Block
{
    public BlockBarbSpawn(int i, int j)
    {
...
//@Override
   ...
   // 	world.addWeatherEffect(new EntityLightningBolt(world, x, y+1, z));
		...
		EntityBarbarian entity = new EntityBarbarian(world);
    ...
    public void registerIcons(IconRegister ir)
    {
            ...
            {
            this.blockIcon = ir.registerIcon("dirt");
            }
    }
}
