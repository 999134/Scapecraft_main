	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		if (quickvar <= 1) {
			...
			MinecraftServer.getServer().getConfigurationManager()
					.sendChatMsg((new ChatMessageComponent().addText("A Black Dragon dropped a dragon chain, hax!")));
		...
		if (quickvar1 <= 1) {
			...
			MinecraftServer.getServer().getConfigurationManager()
					.sendChatMsg((new ChatMessageComponent().addText("A Black Dragon dropped a dragon scimmy")));
		}
		if (quickvar2 <= 1) {
		...
		if (quickvar5 <= 1) {
			...
			MinecraftServer.getServer().getConfigurationManager()
					.sendChatMsg((new ChatMessageComponent().addText("A Black Dragon dropped a gs shard 1!")));
		}
		if (quickvar6 <= 1) {

			entityDropItem(new ItemStack(mod_BlocksGalore.ArmadylHilt), 1);
			MinecraftServer.getServer().getConfigurationManager()
					.sendChatMsg((new ChatMessageComponent().addText("A Black Dragon dropped an armadyl hilt!")));
		}
