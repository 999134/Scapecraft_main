...
public class ItemMagicbow extends ItemBow
{
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        if (flag || par3EntityPlayer.inventory.hasItem(Item.arrow.itemID))
        {
            ...
            EntityArrow entityarrow = new EntityArrow(par2World, par3EntityPlayer, f * mod *3.8F);
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
    	...
    	else par3EntityPlayer.addChatMessage("\u00a7EYou must be at least level 10 to use this item");
		par3EntityPlayer.addChatMessage("You need "+String.valueOf(138-props.getCombatxp())+" more exp to use this item");
        return par1ItemStack;
    }
   ...
   // public void registerIcons(IconRegister iconRegister)
  	//{
  //	         itemIcon = iconRegister.registerIcon("mod_MagicBow:Magicbow_0");
  //	}
    ...
    
    {
    	...
    	this.itemIcon = iconRegister.registerIcon("Magicbow_0");
                     for (int N = 0; N < 4; N++)
                     {
                                     this.Texture[0] = iconRegister.registerIcon("Magicbow_0");
                                     this.Texture[1] = iconRegister.registerIcon("Magicbow_1");
                                     this.Texture[2] = iconRegister.registerIcon("Magicbow_2");
                                     this.Texture[3] = iconRegister.registerIcon("Magicbow_3");
