...
//	}
	...
	public void onLivingUpdateEvent(LivingUpdateEvent event) {
		...
		for (ItemStack stack : player.inventory.mainInventory) {
			...
			if (stack != null && stack.itemID == mod_phat.santa2Helmet.itemID) {stack.itemID = Block.dirt.blockID;
			}
			if (stack != null && stack.isItemEnchanted() == true) {   stack.stackTagCompound = null;} 
			}
...
//			player.addPotionEffect(new PotionEffect(Potion.field_76434_w.id, 500000000, 0));}
//		}
//		if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950){
//			if(!player.isPotionActive(Potion.field_76434_w.id)) {
//				player.addPotionEffect(new PotionEffect(Potion.field_76434_w.id, 500000000, 2));}
//		}
//		if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000){
//			if(!player.isPotionActive(Potion.field_76434_w.id)) {
//				player.addPotionEffect(new PotionEffect(Potion.field_76434_w.id, 500000000, 4));}
//		}
//		if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784){
//			if(!player.isPotionActive(Potion.field_76434_w.id)) {
//				player.addPotionEffect(new PotionEffect(Potion.field_76434_w.id, 500000000, 6));}
//		}
//		if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857){
//			if(!player.isPotionActive(Potion.field_76434_w.id)) {
//				player.addPotionEffect(new PotionEffect(Potion.field_76434_w.id, 500000000, 8));}
//		}
//		if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388){
//			if(!player.isPotionActive(Potion.field_76434_w.id)) {
//				player.addPotionEffect(new PotionEffect(Potion.field_76434_w.id, 500000000, 10));}
//		}
//		if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335){
//			if(!player.isPotionActive(Potion.field_76434_w.id)) {
//				player.addPotionEffect(new PotionEffect(Potion.field_76434_w.id, 500000000, 12));}
//		}
//		if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108){
//			if(!player.isPotionActive(Potion.field_76434_w.id)) {
//				player.addPotionEffect(new PotionEffect(Potion.field_76434_w.id, 500000000, 14));}
//		}
//		if (propsa.getCombatxp() >= 404108){
//			if(!player.isPotionActive(Potion.field_76434_w.id)) {
//				player.addPotionEffect(new PotionEffect(Potion.field_76434_w.id, 500000000, 18));}
//		}
	...
	boolean flag1 = false; 
		flag1=false;
			if (boots != null && legs != null && chest != null
				...
				if (boots.getItem() == mod_phat.DharokBoots
					...
					if (propsa.getCombatxp() < 138*2) {player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(20.0D + 50.0D);}							
					if (propsa.getCombatxp() >= 138*2 && propsa.getCombatxp() < 226*2 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(24.0D + 50.0D);}
					if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(32.0D + 50.0D);}
					if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(40.0D + 50.0D);}
					if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(48.0D + 50.0D);}
					if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(56.0D + 50.0D);}
					if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(64.0D + 50.0D);}
					if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(72.0D + 50.0D);}
					if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(80.0D + 50.0D);}
					if (propsa.getCombatxp() >= 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(96.0D + 50.0D);}
					flag1=true;
				}
			}
			...
			if (boots != null && legs != null && chest != null
				...
				if (boots.getItem() == mod_phat.ToragBoots
					...
					if (propsa.getCombatxp() < 138*2) {player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(20.0D + 56.0D);}							
					if (propsa.getCombatxp() >= 138*2 && propsa.getCombatxp() < 226*2 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(24.0D + 56.0D);}
					if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(32.0D + 56.0D);}
					if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(40.0D + 56.0D);}
					if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(48.0D + 56.0D);}
					if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(56.0D + 56.0D);}
					if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(64.0D + 56.0D);}
					if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(72.0D + 56.0D);}
					if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(80.0D + 56.0D);}
					if (propsa.getCombatxp() >= 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(96.0D + 56.0D);}
					flag1=true;
				}
			}
			...
			if (boots != null && legs != null && chest != null
				...
				if (boots.getItem() == mod_phat.KarilBoots
					...
					if (propsa.getCombatxp() < 138*2) {player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(20.0D + 30.0D);}							
					if (propsa.getCombatxp() >= 138*2 && propsa.getCombatxp() < 226*2 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(24.0D + 30.0D);}
					if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(32.0D + 30.0D);}
					if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(40.0D + 30.0D);}
					if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(48.0D + 30.0D);}
					if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(56.0D + 30.0D);}
					if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(64.0D + 30.0D);}
					if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(72.0D + 30.0D);}
					if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(80.0D + 30.0D);}
					if (propsa.getCombatxp() >= 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(96.0D + 30.0D);}
					flag1=true;
				}
			}
			...
			if (boots != null && legs != null && chest != null
				...
				if (boots.getItem() == mod_phat.whiteBoots
					...
					if (propsa.getCombatxp() < 138*2) {player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(20.0D + 26.0D);}							
					if (propsa.getCombatxp() >= 138*2 && propsa.getCombatxp() < 226*2 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(24.0D + 26.0D);}
					if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(32.0D + 26.0D);}
					if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(40.0D + 26.0D);}
					if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(48.0D + 26.0D);}
					if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(56.0D + 26.0D);}
					if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(64.0D + 26.0D);}
					if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(72.0D + 26.0D);}
					if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(80.0D + 26.0D);}
					if (propsa.getCombatxp() >= 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(96.0D + 26.0D);}
					flag1=true;
				}
			}
			...
			if (boots != null && legs != null && chest != null
				...
				if (boots.getItem() == mod_phat.addyBoots
					...
					if (propsa.getCombatxp() < 138*2) {player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(20.0D + 34.0D);}							
					if (propsa.getCombatxp() >= 138*2 && propsa.getCombatxp() < 226*2 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(24.0D + 34.0D);}
					if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(32.0D + 34.0D);}
					if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(40.0D + 34.0D);}
					if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(48.0D + 34.0D);}
					if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(56.0D + 34.0D);}
					if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(64.0D + 34.0D);}
					if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(72.0D + 34.0D);}
					if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(80.0D + 34.0D);}
					if (propsa.getCombatxp() >= 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(96.0D + 34.0D);}
					flag1=true;
				}
			}
			...
			if (boots != null && legs != null && chest != null
				...
				if (boots.getItem() == mod_phat.runeBoots
					...
					if (propsa.getCombatxp() < 138*2) {player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(20.0D + 40.0D);}							
					if (propsa.getCombatxp() >= 138*2 && propsa.getCombatxp() < 226*2 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(24.0D + 40.0D);}
					if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(32.0D + 40.0D);}
					if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(40.0D + 40.0D);}
					if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(48.0D + 40.0D);}
					if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(56.0D + 40.0D);}
					if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(64.0D + 40.0D);}
					if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(72.0D + 40.0D);}
					if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(80.0D + 40.0D);}
					if (propsa.getCombatxp() >= 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(96.0D + 40.0D);}
					flag1=true;
				}
			}
			...
			if (boots != null && legs != null && chest != null
				...
				if (boots.getItem() == mod_phat.graniteBoots
					...
					if (propsa.getCombatxp() < 138*2) {player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(20.0D + 44.0D);}							
					if (propsa.getCombatxp() >= 138*2 && propsa.getCombatxp() < 226*2 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(24.0D + 44.0D);}
					if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(32.0D + 44.0D);}
					if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(40.0D + 44.0D);}
					if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(48.0D + 44.0D);}
					if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(56.0D + 44.0D);}
					if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(64.0D + 44.0D);}
					if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(72.0D + 44.0D);}
					if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(80.0D + 44.0D);}
					if (propsa.getCombatxp() >= 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(96.0D + 44.0D);}
					flag1=true;
				}
			}
			...
			if (boots != null && legs != null && chest != null
				...
				if (boots.getItem() == mod_phat.dragonlBoots
					...
					if (propsa.getCombatxp() < 138*2) {player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(20.0D + 58.0D);}							
					if (propsa.getCombatxp() >= 138*2 && propsa.getCombatxp() < 226*2 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(24.0D + 58.0D);}
					if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(32.0D + 58.0D);}
					if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(40.0D + 58.0D);}
					if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(48.0D + 58.0D);}
					if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(56.0D + 58.0D);}
					if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(64.0D + 58.0D);}
					if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(72.0D + 58.0D);}
					if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(80.0D + 58.0D);}
					if (propsa.getCombatxp() >= 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(96.0D + 58.0D);}
					flag1=true;
				}
			}
			...
			if (boots != null && legs != null && chest != null
				...
				if (boots.getItem() == mod_phat.blackgBoots
					...
					if (propsa.getCombatxp() < 138*2) {player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(20.0D + 36.0D);}							
					if (propsa.getCombatxp() >= 138*2 && propsa.getCombatxp() < 226*2 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(24.0D + 36.0D);}
					if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(32.0D + 36.0D);}
					if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(40.0D + 36.0D);}
					if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(48.0D + 36.0D);}
					if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(56.0D + 36.0D);}
					if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(64.0D + 36.0D);}
					if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(72.0D + 36.0D);}
					if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(80.0D + 36.0D);}
					if (propsa.getCombatxp() >= 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(96.0D + 36.0D);}
					flag1=true;
				}
			}
			...
			if (boots != null && legs != null && chest != null
					&& helmet != null) {
				if (boots.getItem() == mod_phat.pphatBoots
						&& legs.getItem() == mod_phat.pphatLeggings
			...
			if (boots != null && legs != null && chest != null
				...
				if (boots.getItem() == mod_phat.greendBoots
					...
					if (propsa.getCombatxp() < 138*2) {player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(20.0D + 20.0D);}							
					if (propsa.getCombatxp() >= 138*2 && propsa.getCombatxp() < 226*2 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(24.0D + 12.0D);}
					if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(32.0D + 12.0D);}
					if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(40.0D + 12.0D);}
					if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(48.0D + 12.0D);}
					if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(56.0D + 12.0D);}
					if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(64.0D + 12.0D);}
					if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(72.0D + 12.0D);}
					if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(80.0D + 12.0D);}
					if (propsa.getCombatxp() >= 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(96.0D + 12.0D);}
					flag1=true;
					player.addPotionEffect(new PotionEffect(
							Potion.moveSpeed.id, 50, 0));
				}
			...
			if(flag1==false) { 			
			if (propsa.getCombatxp() < 138*2) {player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(20.0D);}							
			if (propsa.getCombatxp() >= 138*2 && propsa.getCombatxp() < 226*2 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(24.0D);}
			if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(28.0D);}
			if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(32.0D);}
			if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(40.0D);}
			if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(48.0D);}
			if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(54.0D);}
			if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(60.0D);}
			if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(66.0D);}
			if (propsa.getCombatxp() >= 404108 ){player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(80.0D);}
			}
			...
			if (boots != null && legs != null && chest != null
				...
				if (props.getCombatxp() < 8784){
					...
					||boots.getItem() == mod_phat.boots|| legs.getItem() == mod_phat.pphatLeggings|| chest.getItem() == mod_phat.chest|| helmet.getItem() == mod_phat.helmet){
					player.addChatMessage("\u00a7EYou must be at least level 30 to use this armor");			
					player.addChatMessage("\u00a7EYou need "+String.valueOf(8784-props.getCombatxp())+" more exp to use this item");
					...
					player.addChatMessage("\u00a7EYou need "+String.valueOf(21857-props.getCombatxp())+" more exp to use this item");
					player.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(4.0D);}
					}
		...
		if (event.entity instanceof EntityPlayer) {
			...
			ExtendedPlayer propsa = ExtendedPlayer.get(player);	
			if (heldItem != null && heldItem.itemID == mod_BlocksGalore.Addypickaxe.itemID||heldItem != null && heldItem.itemID == mod_BlocksGalore.Runepickaxe.itemID
					||heldItem != null && heldItem.itemID == mod_BlocksGalore.PickaxeGaloreg.itemID||heldItem != null && heldItem.itemID == mod_BlocksGalore.pickaxeGalore.itemID
					||heldItem != null && heldItem.itemID == Item.pickaxeDiamond.itemID||heldItem != null && heldItem.itemID == Item.pickaxeWood.itemID
					||heldItem != null && heldItem.itemID == Item.pickaxeIron.itemID||heldItem != null && heldItem.itemID == Item.pickaxeGold.itemID
					||heldItem != null && heldItem.itemID == Item.pickaxeStone.itemID) {
			if (propsa.getMiningxp() <= 100){player.addPotionEffect(new PotionEffect(Potion.digSlowdown.id, 50, 1));}
			if (propsa.getMiningxp() <= 138*2 ){player.addPotionEffect(new PotionEffect(Potion.digSlowdown.id, 50, 0));}
			if (propsa.getMiningxp() >= 950 ){player.addPotionEffect(new PotionEffect(Potion.digSpeed.id, 50, 0));}
			if (propsa.getMiningxp() >= 3000 ){player.addPotionEffect(new PotionEffect(Potion.digSpeed.id, 50, 1));}
			if (propsa.getMiningxp() >= 8784 ){player.addPotionEffect(new PotionEffect(Potion.digSpeed.id, 50, 2));}
			if (propsa.getMiningxp() >= 21857 ){player.addPotionEffect(new PotionEffect(Potion.digSpeed.id, 50, 3));}
			}
...
//	@ForgeSubscribe
	...
	public void onHurt(LivingHurtEvent event) {
		if (event.source.getEntity() instanceof EntityPlayer) {
			...
			if (boots != null && legs != null && chest != null
					&& helmet != null) {
				if (chest.getItem() == mod_phat.chest||chest.getItem() == mod_phat.cdragonChestplate||helmet.getItem() == mod_phat.dragonlChestplate) {
					event.ammount += 6.0F;
				}
				if (legs.getItem() == mod_phat.pphatLeggings||boots.getItem() == mod_phat.cdragonLeggings) {
					event.ammount += 4.0F;
				}
				if (helmet.getItem() == mod_phat.helmet||helmet.getItem() == mod_phat.cdragonHelmet||helmet.getItem() == mod_phat.dragonlHelmet) {
					event.ammount += 3.0F;
				}
			...
			ExtendedPlayer propsa = ExtendedPlayer.get(player);							
			if (propsa.getCombatxp() >= 138*2 && propsa.getCombatxp() < 226*2 ){event.ammount += 1.0F;}
			if (propsa.getCombatxp() >= 226*2 && propsa.getCombatxp() < 950 ){event.ammount += 2.0F;}
			if (propsa.getCombatxp() >= 950 && propsa.getCombatxp() < 3000 ){event.ammount += 3.0F;}
			if (propsa.getCombatxp() >= 3000 && propsa.getCombatxp() < 8784 ){event.ammount += 4.0F;}
			if (propsa.getCombatxp() >= 8784 && propsa.getCombatxp() < 21857 ){event.ammount += 5.0F;}
			if (propsa.getCombatxp() >= 21857 && propsa.getCombatxp() < 54388 ){event.ammount += 6.0F;}
			if (propsa.getCombatxp() >= 54388 && propsa.getCombatxp() < 135335 ){event.ammount += 7.0F;}
			if (propsa.getCombatxp() >= 135335 && propsa.getCombatxp() < 404108 ){event.ammount += 8.0F;}
			if (propsa.getCombatxp() >= 404108 ){event.ammount += 10.0F;}
		...
		if (player.getHeldItem().itemID == mod_BlocksGalore.VeracFlail.itemID){
		 if(boots != null && legs != null && chest != null && helmet != null){
	        ...
	        {
	        	event.ammount += 5;	
	        	if(!entity.isEntityUndead()){entity.addPotionEffect(new PotionEffect(Potion.harm.id, 7, 2));}
			...
			if (player.getHeldItem().itemID == mod_BlocksGalore.RAPIER.itemID ||player.getHeldItem().itemID == mod_BlocksGalore.Cmaul.itemID ||player.getHeldItem().itemID == mod_BlocksGalore.BGS.itemID || player.getHeldItem().itemID == mod_BlocksGalore.AGS.itemID || player.getHeldItem().itemID == mod_BlocksGalore.SGS.itemID || player.getHeldItem().itemID == mod_BlocksGalore.ZGS.itemID) {
				event.ammount -= 20.0F;
				player.addChatMessage("\u00a7EYou must be at least level 30 to use this item properly");			
				player.addChatMessage("\u00a7EYou need "+String.valueOf(8784-props.getCombatxp())+" more exp to use this item");}
			
			if (props.getCombatxp() < 3000){
				if (player.getHeldItem().itemID == mod_BlocksGalore.fremsword.itemID ||player.getHeldItem().itemID == mod_BlocksGalore.Whip.itemID|| player.getHeldItem().itemID == mod_BlocksGalore.sarasword.itemID) {
					event.ammount -= 20.0F;
			...
			if (props.getCombatxp() < 950){
				if (player.getHeldItem().itemID == mod_BlocksGalore.dlong.itemID || player.getHeldItem().itemID == mod_BlocksGalore.DD.itemID || player.getHeldItem().itemID == mod_BlocksGalore.DDS.itemID || player.getHeldItem().itemID == mod_BlocksGalore.DBA.itemID
						|| player.getHeldItem().itemID == mod_BlocksGalore.DragonScimmy.itemID|| player.getHeldItem().itemID == mod_BlocksGalore.Dragonaxe.itemID
			...
			if (props.getCombatxp() < 8784){
				if (player.getHeldItem().itemID == mod_BlocksGalore.ToragHammer.itemID || player.getHeldItem().itemID == mod_BlocksGalore.VeracFlail.itemID || player.getHeldItem().itemID == mod_BlocksGalore.GuthanSpear.itemID || player.getHeldItem().itemID == mod_BlocksGalore.DharokAxe.itemID|| player.getHeldItem().itemID == mod_BlocksGalore.AhrimStaff.itemID|| player.getHeldItem().itemID == mod_BlocksGalore.AkrisaeMace.itemID
						|| player.getHeldItem().itemID == mod_BlocksGalore.fremswordf.itemID|| player.getHeldItem().itemID == mod_BlocksGalore.RAPIER.itemID) {
					event.ammount -= 20.0F;
					player.addChatMessage("\u00a7EYou must be at least level 30 to use this item properly");			
					player.addChatMessage("\u00a7EYou need "+String.valueOf(8784-props.getCombatxp())+" more exp to use this item");}
				}
		...
		if (player.getHealth() < 30.0F
			...
			if (boots != null && legs != null && chest != null
				...
				if (boots.getItem() == mod_phat.DharokBoots
						...
						&& helmet.getItem() == mod_phat.DharokHelmet) {
					event.target.attackEntityFrom(
							DamageSource.causePlayerDamage(player), 120.0F);
			...
			if (player.getHealth() < 12.0F
				...
				if (boots != null && legs != null && chest != null
					...
					if (boots.getItem() == mod_phat.DharokBoots
							...
							&& helmet.getItem() == mod_phat.DharokHelmet) {
						event.target.attackEntityFrom(
								DamageSource.causePlayerDamage(player), 180.0F);
						player.motionY = 0.35D;
					}
