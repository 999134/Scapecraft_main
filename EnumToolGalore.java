...
public enum EnumToolGalore {
	GALOREG(3, 500, 60.0F, 7.0F, 10), DRAGON(3, 1500, 15.0F, 6.0F, 30), CHAOTIC(3, 2000, 15.0F, 7.0F, 30), KORASIS(3,
			30, 5.0F, 1.0F, 10), MITH(2, 400, 6.5F, 2.0F,
					10), ADDY(2, 700, 7.5F, 3.0F, 10), RUNE(3, 2000, 10.5F, 4.0F, 10), BLACK(2, 300, 6.0F, 2.0F, 15);
	...
	public int getToolCraftingMaterial() {
		switch (this) {
		case MITH:
			return mod_BlocksGalore.Mithingot.itemID;
