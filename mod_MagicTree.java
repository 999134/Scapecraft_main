...
public class mod_MagicTree extends BaseMod {
	...
	public static final Block Magiclog = (new BlockMagiclog(200, 19).setHardness(50.0F).setUnlocalizedName("magiclog")
			.setStepSound(Block.soundWoodFootstep));
	public static final Block Magicleaf = (new BlockMagicleaf(201, 18).setHardness(0.01F)
			.setUnlocalizedName("magicleaf").setStepSound(Block.soundGrassFootstep));
	public static final Block Magicsapling = (new BlockMagicsapling(202, 17).setHardness(0.0F)
			.setUnlocalizedName("magicsapling").setStepSound(Block.soundGrassFootstep));
	public static final Item Magicfruit = new ItemFood(17105, 20, true).setUnlocalizedName("mod_MagicTree:magicfruit")
			.setTextureName("magicfruit");
	...
	public static final Block Magicplank = (new BlockMagicplank(203, 19).setHardness(5.0F)
			.setUnlocalizedName("magicplank").setStepSound(Block.soundWoodFootstep));
	public static final Block Magicstairs = (new BlockMagicstairs(214, mod_MagicTree.Magicplank, 0).setHardness(5.0F)
			.setUnlocalizedName("magicstairs").setStepSound(Block.soundWoodFootstep));
	...
	public void load() {
		...
		GameRegistry.addRecipe(new ItemStack(mod_MagicTree.Magicsapling, 1), new Object[] { "XXX", "XYX", "XXX",
				Character.valueOf('Y'), Item.diamond, Character.valueOf('X'), mod_YewTree.Yewsapling });

		GameRegistry.addRecipe(new ItemStack(mod_MagicTree.Magicplank, 2),
				new Object[] { "X", Character.valueOf('X'), mod_MagicTree.Magiclog });

		GameRegistry.addRecipe(new ItemStack(mod_MagicTree.Magicstick, 1),
				new Object[] { "X", "X", Character.valueOf('X'), mod_MagicTree.Magicplank });

		GameRegistry.addRecipe(new ItemStack(mod_MagicTree.Magicstairs, 4),
				new Object[] { "  X", " XX", "XXX", Character.valueOf('X'), mod_MagicTree.Magicplank });

		GameRegistry.addRecipe(new ItemStack(mod_MagicTree.Magicboat, 1),
				new Object[] { "X X", "XXX", Character.valueOf('X'), mod_MagicTree.Magicplank });
