...
public class ItemRenderRuneHammer implements IItemRenderer {

	protected ModelWarhammer WarHammerModel ;
	
	public ItemRenderRuneHammer(){
	...
	case  ENTITY:
    {
        ...
        Minecraft.getMinecraft().renderEngine.bindTexture(Resources.TEXTURE_RuneHammer);
