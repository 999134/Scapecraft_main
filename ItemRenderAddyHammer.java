...
import net.minecraft.src.Resources;

public class ItemRenderAddyHammer implements IItemRenderer {

	protected ModelWarhammer WarHammerModel ;
	
	public ItemRenderAddyHammer(){
	...
	case  ENTITY:
    {
       ...
       Minecraft.getMinecraft().renderEngine.bindTexture(Resources.TEXTURE_AddyHammer);
