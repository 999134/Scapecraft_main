...
public class mod_Flower extends BaseMod {
	...
	public static final Item fishpie = (new ItemModFood(17011, 4, 10, true)).setAlwaysEdible()
			.setUnlocalizedName("fishpie").setTextureName("fishpie").setMaxStackSize(8);
	public static final Item meatpie = (new ItemModFood(17012, 4, 8, true)).setAlwaysEdible()
			.setUnlocalizedName("meatpie").setTextureName("meatpie").setMaxStackSize(8);
	public static final Item applepie = (new ItemModFood(17013, 4, 7, true)).setAlwaysEdible()
	...
	public void load() {
		...
		ModLoader.addShapelessRecipe(new ItemStack(mod_Flower.cabbagepieuncooked, 1), new Object[] { mod_Flower.cutcabbage, Item.bread });
		ModLoader.addShapelessRecipe(new ItemStack(mod_Flower.fishpieuncooked, 1), new Object[] { Item.fishCooked, Item.bread });
		ModLoader.addShapelessRecipe(new ItemStack(mod_Flower.applepieuncooked, 1), new Object[] { Item.appleRed, Item.bread });
		ModLoader.addShapelessRecipe(new ItemStack(mod_Flower.meatpieuncooked, 1), new Object[] { Item.porkCooked, Item.bread });
		ModLoader.addShapelessRecipe(new ItemStack(mod_Flower.GreenDleather, 1), new Object[] { Item.goldNugget, mod_Flower.GreenDhide });
		ModLoader.addShapelessRecipe(new ItemStack(mod_Flower.BlackDleather, 1), new Object[] { Item.goldNugget, mod_Flower.BlackDhide });
		...
		ModLoader.addRecipe(new ItemStack(mod_Flower.LOL, 1), new Object[] { " X ", "XYX", "XXY",
				Character.valueOf('X'), Block.dirt, Character.valueOf('Y'), Block.wood });
		ModLoader.addShapelessRecipe(new ItemStack(mod_Flower.Stats, 1),
				new Object[] { Block.sand });

		ModLoader.addRecipe(new ItemStack(mod_Flower.cabbagepieuncooked, 1), new Object[] { " X ", "XYX",
				Character.valueOf('X'), Block.wood, Character.valueOf('Y'), Block.torchWood });
