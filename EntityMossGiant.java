...
public class EntityMossGiant extends EntityMob
{
...
protected String getLivingSound()
    ...
    protected void dropFewItems(boolean par1, int par2){
        ...
        int quickvar1 = rand.nextInt(1300) + 1;
        ...
        int quickvar9 = rand.nextInt(10) + 1;
        int quickvar10 = rand.nextInt(40) + 1;
         
 if(quickvar <= 1){entityDropItem(new ItemStack(mod_BlocksGalore.dlong), 1);
 MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("A Moss Giant has dropped a dragon longsword!")));}
if(quickvar1 <= 1){entityDropItem(new ItemStack(mod_phat.dragonLeggings), 1);
MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("A Moss Giant has dropped some dragon platelegs!")));}
...
int XP1 = rand.nextInt(1) + 1;if(XP <= 1){entityDropItem(new ItemStack(mod_Flower.XPORB), 1);}
    ...
    {
    	ModLoader.getMinecraftInstance().thePlayer.addChatMessage("\u00a7EMoss Giant: Smash!");
