...
public class ItemMithpickaxe extends ItemTool {
	...
	protected ItemMithpickaxe(int par1, EnumToolMaterial par2EnumToolMaterial) {
	...
	public float getStrVsBlock(ItemStack par1ItemStack, Block par2Block) {
	  ...
	  @SideOnly(Side.CLIENT)
	    ...
	    {
	            {
	            this.itemIcon = ir.registerIcon("Mithpickaxe");
	            }
	    }
}
