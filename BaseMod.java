...
public abstract class BaseMod implements cpw.mods.fml.common.modloader.BaseModProxy {
	...
	/*
	 * public final void onRenderHarvest(Map renderers) { addRenderer((Map<Class<?
	 * extends Entity>,Render>)renderers); }
	 * 
	 * public final void onRegisterAnimations() {
	 * registerAnimation(FMLClientHandler.instance().getClient()); }
	 * 
	 * @Override public final void onCrafting(Object... craftingParameters) {
	 * takenFromCrafting((EntityPlayer)craftingParameters[0],
	 * (ItemStack)craftingParameters[1], (IInventory)craftingParameters[2]); }
	 * 
	 * @Override public final void onSmelting(Object... smeltingParameters) {
	 * takenFromFurnace((EntityPlayer)smeltingParameters[0],
	 * (ItemStack)smeltingParameters[1]); }
	 * 
	 * @Override public final boolean dispense(double x, double y, double z, int
	 * xVelocity, int zVelocity, Object... data) { return
	 * dispenseEntity((World)data[0], x, y, z, xVelocity, zVelocity,
	 * (ItemStack)data[1]); }
	 * 
	 * @Override public final boolean onChat(Object... data) {
	 * receiveChatPacket(((Packet3Chat)data[0]).message); return true; }
	 * 
	 * 
	 * @Override public final void onServerLogin(Object handler) {
	 * serverConnect((NetClientHandler) handler); }
	 * 
	 * public final void onServerLogout() { serverDisconnect(); }
	 * 
	 * @Override public final void onPlayerLogin(Object player) {
	 * onClientLogin((EntityPlayer) player); }
	 * 
	 * @Override public final void onPlayerLogout(Object player) {
	 * onClientLogout((EntityPlayer)player); }
	 * 
	 * @Override public final void onPlayerChangedDimension(Object player) {
	 * onClientDimensionChanged((EntityPlayer)player); }
	 * 
	 * @Override public final void onPacket250Packet(Object... data) {
	 * receiveCustomPacket((Packet250CustomPayload)data[0]); }
	 * 
	 * @Override public final void notifyPickup(Object... pickupData) { EntityItem
	 * item = (EntityItem) pickupData[0]; EntityPlayer player = (EntityPlayer)
	 * pickupData[1]; onItemPickup(player, item.field_70294_a); }
	 * 
	 * @Override public final void generate(Random random, int chunkX, int chunkZ,
	 * Object... additionalData) { World w = (World) additionalData[0];
	 * IChunkProvider cp = (IChunkProvider) additionalData[1];
	 * 
	 * if (cp instanceof ChunkProviderGenerate) { generateSurface(w, random, chunkX
	 * << 4, chunkZ << 4); } else if (cp instanceof ChunkProviderHell) {
	 * generateNether(w, random, chunkX << 4, chunkZ << 4); } }
	 * 
	 * @Override public final boolean handleCommand(String command, Object... data)
	 * { return false; }
	 * 
	 */
	// BASEMOD API
	/**
	 * Override if you wish to provide a fuel item for the furnace and return the
	 * fuel value of the item
	 *
	 * @param id
	 * @param metadata
	 */
	 ...
	 *
	 * @param time
	 *            the rendering subtick time (0.0-1.0)
