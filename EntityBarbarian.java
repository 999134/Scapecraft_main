...
MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("A Barbarian dropped some Dragon Platelegs!")));
}
if(quickvar2 <= 1){entityDropItem(new ItemStack(mod_phat.whiteLeggings), 1);}
if(quickvar3 <= 1){	entityDropItem(new ItemStack(mod_phat.whiteBoots), 1);}
if(quickvar4 <= 1){	entityDropItem(new ItemStack(mod_phat.whiteHelmet), 1);}
...
if(quickvar7 <= 1){	entityDropItem(new ItemStack(mod_phat.helmet), 1);
MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("A Barbarian dropped a Berserker helm!")));
}
int XP = rand.nextInt(1) + 1;if(XP <= 1){entityDropItem(new ItemStack(mod_Flower.XPORB), 1);}
 ...
 static
         {
                 defaultHeldItem = new ItemStack(mod_BlocksGalore.DharokAxe, 1);
         }
 ...
 {
 	ModLoader.getMinecraftInstance().thePlayer.addChatMessage("\u00a7EBarbarian:You look weak");
