...
public class EntityChristmasGuard extends EntityMob {
	private float moveSpeed;

	public EntityChristmasGuard(World par1World) {
		super(par1World);
	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		// int XP = rand.nextInt(1) + 1;if(XP <= 1){entityDropItem(new
		// ItemStack(mod_Flower.XPORB), 1);}
	}
	...
	public boolean interact(EntityPlayer par1EntityPlayer) {
		ModLoader.getMinecraftInstance().thePlayer.addChatMessage("\u00a7EChristmasGuard: Merry Christmas!");
