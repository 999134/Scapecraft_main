...
public class EntityFremGuard extends EntityMob
{
...
protected String getLivingSound()
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
  	  ...
  	  if(!worldObj.isRemote) {	ModLoader.getMinecraftInstance().thePlayer.addChatMessage("\u00a7EFremmick Guard: Clicking here will take you to the home of Koschei the Deathless, you will need a gold ingot to summon him and items are not lost in there, good luck");
    ...
    public void func_82163_bD()
    {
    	 ...
    	 this.setCanPickUpLoot(this.rand.nextFloat() < equipmentDropChances[this.worldObj.difficultySetting]);
    	   if (this.getCurrentItemOrArmor(4) == null){
    		   ...
    		   this.setCurrentItemOrArmor(3, new ItemStack(mod_phat.runegChestplate));
    		   this.setCurrentItemOrArmor(2, new ItemStack(mod_phat.runegLeggings));
 ...
 static
         {
                 defaultHeldItem = new ItemStack(mod_BlocksGalore.fremsword, 1);
         }
