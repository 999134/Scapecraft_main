...
public class ItemToragHammer extends ItemSword
{
    private float weaponDamage;
    private final EnumToolMaterial toolMaterial;

    public ItemToragHammer(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase)
    {
        ...
        chest.getItem() == mod_phat.ToragChestplate && helmet.getItem() == mod_phat.ToragHelmet)
        {
        	  ...
        	  par2EntityLivingBase.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 200, 1));
        	  }}
    ...
    public void registerIcons(IconRegister ir)
    {
          //  if(itemID == mod_BlocksMaterial.Addyaxe.itemID)
            {
            this.itemIcon = ir.registerIcon("ToragHammerinv");
            }
    }
}
