...
public class mod_Botter extends BaseMod {
	...
	public void load() {
		...
		ModLoader.addSpawn(EntityHellhound.class, 0, 0, 0, EnumCreatureType.monster,
		...
		ModLoader.addSpawn(EntityLesserDemon2.class, 20, 3, 3, EnumCreatureType.monster,
				new BiomeGenBase[] { BiomeGenBase.hell });
		...
		EntityRegistry.registerGlobalEntityID(EntityLavaBlock.class, "LavaBlock",
