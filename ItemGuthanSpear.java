...
public class ItemGuthanSpear extends ItemSword
{
    private float weaponDamage;
    private final EnumToolMaterial toolMaterial;

    public ItemGuthanSpear(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
    ...
    public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase)
    {
        ...
        chest.getItem() == mod_phat.GuthanChestplate && helmet.getItem() == mod_phat.GuthanHelmet)
        {
        	  ...
        	  par3EntityLivingBase.addPotionEffect(new PotionEffect(Potion.regeneration.id, 100, 1));
        	  }}
    ...
    public void registerIcons(IconRegister ir)
    {
          //  if(itemID == mod_BlocksMaterial.Addyaxe.itemID)
            {
            this.itemIcon = ir.registerIcon("GuthanSpearinv");
            }
    }
}
