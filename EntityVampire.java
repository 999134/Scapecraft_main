...
public class EntityVampire extends EntityMob
{
    ...
    // Max Health - default 20.0D - min 0.0D - max Double.MAX_VALUE
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(50000.0D);
...
protected String getLivingSound()
    ...
    protected void dropFewItems(boolean par1, int par2){
        ...
        if(quickvar1 <= 1){
        	...
        	entityDropItem(new ItemStack(mod_Flower.QuestPoint), 1);
...
if(quickvar4 <= 1){
	...
	entityDropItem(new ItemStack(mod_phat.blackHelmet), 1);
...
MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("A player has completed vampire slayer!")));
        }
   ...
   public EnumCreatureAttribute getCreatureAttribute()
    ...
    {
      	if(ticksExisted > 1800 * 20) setDead(); 
