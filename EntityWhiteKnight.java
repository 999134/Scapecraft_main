...
protected String getLivingSound()
    ...
    protected void dropFewItems(boolean par1, int par2){
        ...
        int quickvar6 = rand.nextInt(160) + 1;
        ...
        if(quickvar1 <= 1){
        	...
        	MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("A White Knight has dropped some dragon platelegs!")));
        }
if(quickvar2 <= 1){
            
        	entityDropItem(new ItemStack(mod_phat.whiteLeggings), 1);
...
int XP = rand.nextInt(1) + 1;if(XP <= 1){entityDropItem(new ItemStack(mod_Flower.XPORB), 1);}
    ...
    public void func_82163_bD()
    {
    	 ...
    	 this.setCanPickUpLoot(this.rand.nextFloat() < equipmentDropChances[this.worldObj.difficultySetting]);
    	   if (this.getCurrentItemOrArmor(4) == null){
            ...
            this.setCurrentItemOrArmor(4, new ItemStack(mod_phat.whiteHelmet));
            this.setCurrentItemOrArmor(1, new ItemStack(mod_phat.whiteBoots));
 ...
 public boolean interact(EntityPlayer par1EntityPlayer)
 {
	...
	if (props.getTheifcd() >=  99 ){
	  if(!worldObj.isRemote) {ModLoader.getMinecraftInstance().thePlayer.addChatMessage("\u00a7EWhiteKnight: For Falador!");}}
