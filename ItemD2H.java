...
public class ItemD2H extends ItemSword {
	private float weaponDamage;
	private final EnumToolMaterial toolMaterial;
	public static int activespeciald2h;

	public ItemD2H(int par1, EnumToolMaterial par2EnumToolMaterial) {
	...
	public void registerIcons(IconRegister ir) {
		...
		{
			this.itemIcon = ir.registerIcon("d2h");
		}
	}
}
