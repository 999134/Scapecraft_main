...
public class ItemSaraSword extends ItemSword {
	private float weaponDamage;
	private final EnumToolMaterial toolMaterial;
	private int special = 0;
	public static int activespecialss;

	public ItemSaraSword(int par1, EnumToolMaterial par2EnumToolMaterial) {
	...
	public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase,
		...
		if (special == 1) {
			...
			par2EntityLivingBase.motionX = 0.00D;
			par2EntityLivingBase.motionY = 0.00D;
			par2EntityLivingBase.motionZ = 0.00D;
			par2EntityLivingBase.setFire(100);
			par2EntityLivingBase.worldObj.addWeatherEffect(new EntityLightningBolt(par2EntityLivingBase.worldObj,
					par2EntityLivingBase.posX, par2EntityLivingBase.posY, par2EntityLivingBase.posZ));
	...
	public void registerIcons(IconRegister ir) {
		...
		{
			this.itemIcon = ir.registerIcon("sarasword");
		}
	}
}
