...
public class ItemContract3 extends Item {

	public static int counter = 0;
	Random r = new Random();

	public ItemContract3(int i) {
		super(i);
	...
	public static MovingObjectPosition rayTrace(double par1, float par3, EntityPlayer entityplayer) {
		Vec3 var4 = ItemContract3.getPosition(par3, entityplayer);
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer) {
		if (!world.isRemote && itemstack.getItemDamage() == 0) {
			if (itemstack.getItemDamage() == 0) {
				MovingObjectPosition movingobjectposition = ItemContract3.rayTrace(250.0D, 1.0F, entityplayer);
				...
				EntityWizard entityspawning = new EntityWizard(world);
