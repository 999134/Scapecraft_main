...
public class EntityHillGiant extends EntityMob
{
...
protected String getLivingSound()
    ...
    protected void dropFewItems(boolean par1, int par2){
        ...
        int quickvar2 = rand.nextInt(23) + 1;
        int quickvar3 = rand.nextInt(70) + 1;
        ...
        int quickvar8 = rand.nextInt(25) + 1;
        int quickvar9 = rand.nextInt(30) + 1;
        int quickvar10 = rand.nextInt(90) + 1;
         
 if(quickvar <= 1){entityDropItem(new ItemStack(mod_BlocksGalore.dlong), 1);
	MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("a hill giant has dropped a dragon long")));}
if(quickvar1 <= 1){entityDropItem(new ItemStack(mod_phat.dragonLeggings), 1);
MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("a hill giant has dropped some dragon platelegs")));}
...
if(quickvar4 <= 1){entityDropItem(new ItemStack(mod_phat.blackHelmet), 1);}
...
int XP = rand.nextInt(1) + 1;if(XP <= 1){entityDropItem(new ItemStack(mod_Flower.XPORB), 1);}
    ...
    {
    	ModLoader.getMinecraftInstance().thePlayer.addChatMessage("\u00a7EHill Giant: Smash!");
