...
public class ItemRunepickaxe extends ItemTool {
	...
	protected ItemRunepickaxe(int par1, EnumToolMaterial par2EnumToolMaterial) {
	...
	public float getStrVsBlock(ItemStack par1ItemStack, Block par2Block) {
	  ...
	  @SideOnly(Side.CLIENT)
	    ...
	    {
	            {
	            this.itemIcon = ir.registerIcon("Runepickaxe");
	            }
	    }
}
