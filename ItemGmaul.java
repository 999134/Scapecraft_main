...
public class ItemGmaul extends ItemSword {
	private float weaponDamage;
	private final EnumToolMaterial toolMaterial;
	public static int activespecialgmaul;

	public ItemGmaul(int par1, EnumToolMaterial par2EnumToolMaterial) {
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		if (props.getEnergy() > 9800) {
			props.addEnergy(-10000);
			activespecialgmaul = 1;
	...
	public void registerIcons(IconRegister ir) {
		...
		{
			this.itemIcon = ir.registerIcon("gmaul");
		}
	}
}
