...
public class EntityLesserDemon2 extends EntityMob
{
    private float moveSpeed;


	public EntityLesserDemon2(World par1World)
    {
        super(par1World);
;
        this.moveSpeed = 0.5F;
    ...
    protected void dropFewItems(boolean par1, int par2){
        ...
        int quickvar1 = rand.nextInt(1400) + 1;
        ...
        if(quickvar <= 1){
        	...
        	entityDropItem(new ItemStack(mod_BlocksGalore.RAPIER), 1);
        	   MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("A Lesser Demon has dropped a chaotic rapier!")));
        }
        if(quickvar1 <= 1){
            
        	entityDropItem(new ItemStack(mod_BlocksGalore.DBA), 1);
        	 MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("A Lesser Demon has dropped a dragon battleaxe!")));
        }
if(quickvar2 <= 1){
...
if(quickvar5 <= 1){
	...
	entityDropItem(new ItemStack(mod_BlocksGalore.shard3), 1);
	 MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("A Lesser Demon has dropped a godsword shard 3!")));
}
