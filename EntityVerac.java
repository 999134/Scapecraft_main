...
public class EntityVerac extends EntityMob
{
...
protected String getLivingSound()
    ...
    protected void dropFewItems(boolean par1, int par2){
        ...
        if(quickvar <= 1){
        	...
        	entityDropItem(new ItemStack(mod_BlocksGalore.VeracFlail), 1);
...
if(quickvar2 <= 1){
        	...
        	entityDropItem(new ItemStack(mod_phat.VeracLeggings), 1);
         
        }
if(quickvar3 <= 1){
    
	entityDropItem(new ItemStack(mod_phat.VeracBoots), 1);
 
}
if(quickvar4 <= 1){
    
	entityDropItem(new ItemStack(mod_phat.VeracHelmet), 1);
 
}
if(quickvar5 <= 1){
    
	entityDropItem(new ItemStack(mod_phat.VeracChestplate), 1);
 
}
if(quickvar6 <= 1){
    
	entityDropItem(new ItemStack(mod_Flower.VeracKey), 1);
