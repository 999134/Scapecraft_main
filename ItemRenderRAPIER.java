...
public class ItemRenderRAPIER implements IItemRenderer {

	protected ModelRapier RAPIERModel ;
	
	public ItemRenderRAPIER(){
	...
	case  ENTITY:
    {
        ...
        Minecraft.getMinecraft().renderEngine.bindTexture(Resources.TEXTURE_RAPIER);
...
GL11.glPushMatrix();
		...
		GL11.glTranslatef(4.00F, 0.00F, -0.5F);
