...
public class EntityLootChest extends EntityMob
{
    ...
    {
      return "Loot Chest Black Knights Fortress";
    }
...
protected String getLivingSound()
 ...
 protected void dropFewItems(boolean par1, int par2){
        ...
        if(quickvar <= 1){entityDropItem(new ItemStack(Item.ingotGold), 1);}
        if(quickvar1 <= 1){entityDropItem(new ItemStack(Item.ingotGold), 1);}
        if(quickvar2 <= 1){entityDropItem(new ItemStack(mod_Flower.fishpieuncooked), 1);}
        if(quickvar2 <= 1){entityDropItem(new ItemStack(mod_Flower.fishpieuncooked), 1);}
        if(quickvar2 <= 1){entityDropItem(new ItemStack(mod_Flower.fishpieuncooked), 1);}
        if(quickvar2 <= 1){entityDropItem(new ItemStack(mod_Flower.fishpieuncooked), 1);}
        if(quickvar2 <= 1){entityDropItem(new ItemStack(mod_Flower.fishpieuncooked), 1);}
        ...
        if(quickvar2 <= 1){entityDropItem(new ItemStack(mod_Flower.fishpieuncooked), 1);}
        if(quickvar2 <= 1){entityDropItem(new ItemStack(mod_Flower.fishpieuncooked), 1);}
        if(quickvar3 <= 2){entityDropItem(new ItemStack(mod_Flower.QuestPoint3), 1);}
        if(quickvar4 <= 1){entityDropItem(new ItemStack(mod_BlocksGalore.Whitesword), 1);}
        if(quickvar5 <= 1){entityDropItem(new ItemStack(mod_phat.whiteChestplate), 1);}
        if(quickvar6 <= 1){entityDropItem(new ItemStack(mod_phat.whiteLeggings), 1);}
        if(quickvar7 <= 1){entityDropItem(new ItemStack(mod_phat.whiteBoots), 1);}
        if(quickvar8 <= 1){entityDropItem(new ItemStack(mod_phat.whiteHelmet), 1);}
        int XP = rand.nextInt(1) + 1;if(XP <= 1){entityDropItem(new ItemStack(mod_Flower.BXPORB), 1);}
        int XP1 = rand.nextInt(1) + 1;if(XP1 <= 1){entityDropItem(new ItemStack(mod_Flower.BXPORB), 1);}
        int XP2 = rand.nextInt(1) + 1;if(XP2 <= 1){entityDropItem(new ItemStack(mod_Flower.BXPORB), 1);}
        MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("A player has completed Black Knights Fortress!")));
