...
public class mod_YewTree extends BaseMod {
	...
	public static final Block Yewleaf = (new BlockYewleaf(211, 22).setHardness(0.01F).setUnlocalizedName("yewleaf")
			.setStepSound(Block.soundGrassFootstep));
	public static final Block Yewsapling = (new BlockYewsapling(212, 21).setHardness(0.0F)
			.setUnlocalizedName("yewsapling").setStepSound(Block.soundGrassFootstep));
	...
	public static final Block Yewplank = (new BlockYewplank(213, 19).setHardness(50.0F).setUnlocalizedName("yewplank")
			.setStepSound(Block.soundWoodFootstep));
	public static final Block Yewstairs = (new BlockYewstairs(215, mod_YewTree.Yewplank, 0).setHardness(50.0F)
			.setUnlocalizedName("yewstairs").setStepSound(Block.soundWoodFootstep));
	...
	public void load() {
		...
		GameRegistry.addRecipe(new ItemStack(mod_YewTree.Yewplank, 2),
				new Object[] { "X", Character.valueOf('X'), mod_YewTree.Yewlog });

		GameRegistry.addRecipe(new ItemStack(mod_YewTree.Yewstick, 1),
				new Object[] { "X", "X", Character.valueOf('X'), mod_YewTree.Yewplank });

		GameRegistry.addRecipe(new ItemStack(mod_YewTree.Yewstairs, 4),
				new Object[] { "  X", " XX", "XXX", Character.valueOf('X'), mod_YewTree.Yewplank });
