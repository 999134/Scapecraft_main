...
public ItemGloves2(int i)
  ...
  public boolean itemInteractionForEntity(ItemStack par1ItemStack, EntityPlayer EntityPlayer, EntityLivingBase par3EntityLivingBase )
  {
 ...
 else {EntityPlayer.attackEntityFrom(DamageSource.cactus, 1.0F); }}}return true;}
      ...
      {	  if(!EntityPlayer.worldObj.isRemote) {
    	...
    	else {EntityPlayer.attackEntityFrom(DamageSource.cactus, 2.0F); }}}}
  		else {EntityPlayer.addChatMessage("\u00a7EYou need level 20 Thieving to attempt to pickpocket from this NPC");}
  		}return true;}
    	 ...
    	 ExtendedPlayer.get(EntityPlayer).addTXp(3);
    	  ...
    	  if (loot>1 && loot<100) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.goldNugget,3));} 
     	  ...
     	  if (loot>580 && loot<600) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_phat.whiteBoots));} 
      	  if (loot>560 && loot<930) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.coal,1));} 
      	  if (loot>930 && loot<1000) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_BlocksGalore.Mithore,1));} 
      	  if (loot==1000 && rate>75) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_Flower.gloves2,1));} 
    	 }
    	else {EntityPlayer.attackEntityFrom(DamageSource.cactus, 5.0F); }}}}
    	 ...
    	 ExtendedPlayer.get(EntityPlayer).addTXp(3);
    	  ...
    	  if (loot>1 && loot<100) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.goldNugget,5));} 
     	  ...
     	  if (loot>580 && loot<600) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_Flower.Ltab));} 
      	  if (loot>560 && loot<930) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.flint,1));} 
      	  if (loot>930 && loot<1000) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_BlocksGalore.Addyore,1));} 
      	  if (loot==1000 && rate>75) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_Flower.gloves2,1));} 
    	 }
      ...
      {	  if(!EntityPlayer.worldObj.isRemote) {
    	 ...
    	 ExtendedPlayer.get(EntityPlayer).addTXp(10);
    	  ...
    	  if (loot>1 && loot<100) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.goldNugget,9));} 
     	  ...
     	  if (loot>580 && loot<600) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_phat.whiteBoots));} 
      	  ...
      	  if (loot>990 && loot<1000) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_phat.dragonBoots,1));
    	...
    	else {EntityPlayer.attackEntityFrom(DamageSource.cactus, 15.0F); }}}}
      ...
      {	  if(!EntityPlayer.worldObj.isRemote) {
    	 ...
    	 ExtendedPlayer.get(EntityPlayer).addTXp(50);
    	  ...
    	  if (loot>1 && loot<100) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.goldNugget,9));} 
      	  ...
      	  if (loot>530 && loot<560) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_phat.runeHelmet));} 
     	  if (loot>560 && loot<580) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_phat.runeLeggings));} 
     	  if (loot>580 && loot<600) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_phat.runeBoots));} 
      	  if (loot>560 && loot<930) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.coal,32));} 
      	  if (loot>990 && loot<1000) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_BlocksGalore.sarasword,1));
      	MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("Someone has stolen a saradomin sword!")));} 
      	  if (loot==1000) {EntityPlayer.inventory.addItemStackToInventory(new ItemStack(mod_BlocksGalore.HeroKnightSpawn,1));
      	MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("Someone has stolen a Hero Knight spawner!")));} 
    	 }
    	else {EntityPlayer.attackEntityFrom(DamageSource.cactus, 20.0F); }}}}
  		else {EntityPlayer.addChatMessage("\u00a7EYou need level 35 Thieving to attempt to pickpocket from this NPC");}
  		}return true;}
