...
public class ItemBGS extends ItemSword {
	private float weaponDamage;
	private final EnumToolMaterial toolMaterial;
	private int special = 0;
	public static int activespecialbgs;

	public ItemBGS(int par1, EnumToolMaterial par2EnumToolMaterial) {
	...
	public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase,
		...
		if (special == 1) {
			...
			par2EntityLivingBase.motionY = 1.75D;
	...
	public void registerIcons(IconRegister ir) {
		{
			this.itemIcon = ir.registerIcon("BandosGodsword");
		}
	}
}
