	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		if (quickvar1 <= 1) {
			...
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("Koschei the Deathless has dropped a crystal bow!")));
		}
		if (quickvar2 <= 1) {
			entityDropItem(new ItemStack(mod_phat.dragonHelmet), 1);
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("Koschei the Deathless has dropped a dragon helmet!")));
		}
		if (quickvar3 <= 2) {
			entityDropItem(new ItemStack(mod_BlocksGalore.DiamondSpawn), 1);
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("Koschei the Deathless has dropped a diamond spawner!")));
		}
		if (quickvar4 <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.CabbageSpawn), 1);
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("Koschei the Deathless has dropped a cabbage spawner!")));
		}
		if (quickvar5 <= 1) {
			entityDropItem(new ItemStack(mod_phat.mithChestplate), 1);
		}
		if (quickvar6 <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.fremsword), 1);
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("Koschei the Deathless has dropped a fremmick sword!")));
		}
		if (quickvar7 <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.fremswordf), 1);
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent()
					.addText("Koschei the Deathless has dropped a burning fremmick sword!")));
		}
		if (quickvar8 <= 1) {
			entityDropItem(new ItemStack(mod_phat.runegBoots), 1);
		}
		if (quickvar9 <= 1) {
			entityDropItem(new ItemStack(mod_phat.dragonLeggings), 1);
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("Koschei the Deathless has dropped some dragon platelegs!")));
		}
		if (quickvar10 <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.MithoreSpawn), 1);
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("Koschei the Deathless has dropped a mith ore spawner!")));
		}
		if (quickvar11 <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.AddyoreSpawn), 1);
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("Koschei the Deathless has dropped an addy ore spawner!")));
		}
		if (quickvar12 <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.RuneoreSpawn), 1);
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("Koschei the Deathless has dropped a rune ore spawner!")));
		}
		if (quickvar13 <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.CoalSpawn), 1);
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("Koschei the Deathless has dropped a coal ore spawner!")));
		}
		...
		if (XP <= 1) {
			...
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("Koschei the Deathless has been finally killed!")));
		}
		int XP1 = rand.nextInt(1) + 1;
		if (XP <= 1) {
			entityDropItem(new ItemStack(mod_Flower.BXPORB), 1);
		}
		int XP2 = rand.nextInt(1) + 1;
		if (XP <= 1) {
			entityDropItem(new ItemStack(mod_Flower.BXPORB), 1);
		}
		int XP3 = rand.nextInt(1) + 1;
		if (XP <= 1) {
			entityDropItem(new ItemStack(mod_Flower.BXPORB), 1);
		}
		...
		if (spawnvar >= 20) {
			if (!worldObj.isRemote) {
				...
				for (int k = 0; k < j; ++k) {
					...
					entityKos4.setLocationAndAngles(this.posX + (double) f, this.posY + 0.5D + 1,
