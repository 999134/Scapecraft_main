...
public class EntityAhrim extends EntityMob
{
...
protected String getLivingSound()
    ...
    protected void dropFewItems(boolean par1, int par2){
        ...
        if(quickvar <= 1){
        	...
        	entityDropItem(new ItemStack(mod_BlocksGalore.AhrimStaff), 1);
...
if(quickvar2 <= 1){
        	...
        	entityDropItem(new ItemStack(mod_phat.AhrimLeggings), 1);
         
        }
if(quickvar3 <= 1){
    
	entityDropItem(new ItemStack(mod_phat.AhrimBoots), 1);
 
}
if(quickvar4 <= 1){
    
	entityDropItem(new ItemStack(mod_phat.AhrimHelmet), 1);
 
}
if(quickvar5 <= 1){
    
	entityDropItem(new ItemStack(mod_phat.AhrimChestplate), 1);
 
}
if(quickvar6 <= 1){
    
	entityDropItem(new ItemStack(mod_Flower.AhrimKey), 1);
