...
if(quickvar2 <= 1){
        	...
        	MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("a scorpion has dropped a dragon pickaxe!")));
         
        }
if(quickvar3 <= 2){
    
	entityDropItem(new ItemStack(mod_MagicTree.Magiclog), 1);
