...
public class ItemDarkBow extends ItemBow {
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		if (props.getCombatxp() > 500) {
			...
			par3EntityPlayer.addChatMessage("\u00a7EYou must be at least level 20 to use this item");
		par3EntityPlayer
				.addChatMessage("You need " + String.valueOf(500 - props.getCombatxp()) + " more exp to use this item");
		return par1ItemStack;
	}
