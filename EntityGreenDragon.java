	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		if (quickvar <= 1) {
			...
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("a green dragon has dropped a dragon chainbody!")));
		}
		if (quickvar1 <= 1) {

			entityDropItem(new ItemStack(mod_BlocksGalore.DragonScimmy), 1);
			MinecraftServer.getServer().getConfigurationManager()
					.sendChatMsg((new ChatMessageComponent().addText("a green dragon has dropped a dragon scimmy!")));
		}
		if (quickvar2 <= 1) {
		...
		if (quickvar5 <= 1) {
			...
			MinecraftServer.getServer().getConfigurationManager().sendChatMsg(
					(new ChatMessageComponent().addText("a green dragon has dropped a godsword shard 1!")));
		}
		if (quickvar6 <= 1) {

			entityDropItem(new ItemStack(mod_Flower.Dragon), 1);
			MinecraftServer.getServer().getConfigurationManager()
					.sendChatMsg((new ChatMessageComponent().addText("a green dragon has dropped a hatchling!")));
		}
