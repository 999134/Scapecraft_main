...
public class mod_MagicBow extends BaseMod {
	...
	public static final Item KarilBow = new ItemKarilBow(10021).setUnlocalizedName("mod_MagicBow:KarilCbowInv")
			.setFull3D();
	...
	public void load() {
		...
		GameRegistry.addRecipe(new ItemStack(Magicbow, 1), new Object[] { " XY", "X Y", " XY", Character.valueOf('X'),
				mod_MagicTree.Magicstick, Character.valueOf('Y'), Item.silk });
		GameRegistry.addRecipe(new ItemStack(Yewbow, 1), new Object[] { " XY", "X Y", " XY", Character.valueOf('X'),
				mod_YewTree.Yewstick, Character.valueOf('Y'), Item.silk });
		GameRegistry.addRecipe(new ItemStack(mod_MagicBow.BoltRack, 3), new Object[] { " X ", " Y ",
				Character.valueOf('X'), mod_MagicTree.Magicplank, Character.valueOf('Y'), Item.arrow, });
