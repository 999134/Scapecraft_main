...
public class RenderMagicBoat extends Render {
	 ...
	 */
	public void renderMagicBoat(EntityMagicBoat par1EntityBoat, double par2, double par4, double par6, float par8,
			float par9) {
		GL11.glPushMatrix();
		...
		if (f2 > 0.0F) {
			GL11.glRotatef(MathHelper.sin(f2) * f2 * f3 / 10.0F * (float) par1EntityBoat.getForwardDirection(), 1.0F,
					0.0F, 0.0F);
		}
