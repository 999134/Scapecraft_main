...
public class EntityEliteBlackKnight extends EntityMob
{
    ...
    protected void dropFewItems(boolean par1, int par2){
        ...
        if(quickvar1 <= 1){
        	...
        	entityDropItem(new ItemStack(mod_phat.dragonLeggings), 1);
           	MinecraftServer.getServer().getConfigurationManager().sendChatMsg((new ChatMessageComponent().addText("A Black Knight dropped some dragon platelegs!")));
...
if(quickvar3 <= 1){
	...
	entityDropItem(new ItemStack(mod_phat.blackgBoots), 1);
 
}
if(quickvar4 <= 1){
    
	entityDropItem(new ItemStack(mod_phat.blackgHelmet), 1);
 
}
if(quickvar5 <= 1){
    
	entityDropItem(new ItemStack(mod_phat.blackgChestplate), 1);
    ...
    public void func_82163_bD()
    {
    	 ...
    	 this.setCanPickUpLoot(this.rand.nextFloat() < equipmentDropChances[this.worldObj.difficultySetting]);
    	   if (this.getCurrentItemOrArmor(4) == null){
    		  ...
    		  this.setCurrentItemOrArmor(4, new ItemStack(mod_phat.blackgHelmet));
           ...
           this.setCurrentItemOrArmor(3, new ItemStack(mod_phat.blackgChestplate));
