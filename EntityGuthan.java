...
public class EntityGuthan extends EntityMob
{
...
protected String getLivingSound()
    ...
    protected void dropFewItems(boolean par1, int par2){
        ...
        if(quickvar <= 1){
        	...
        	entityDropItem(new ItemStack(mod_BlocksGalore.GuthanSpear), 1);
...
if(quickvar2 <= 1){
        	...
        	entityDropItem(new ItemStack(mod_phat.GuthanLeggings), 1);
         
        }
if(quickvar3 <= 1){
    
	entityDropItem(new ItemStack(mod_phat.GuthanBoots), 1);
 
}
if(quickvar4 <= 1){
    
	entityDropItem(new ItemStack(mod_phat.GuthanHelmet), 1);
 
}
if(quickvar5 <= 1){
    
	entityDropItem(new ItemStack(mod_phat.GuthanChestplate), 1);
 
}
if(quickvar6 <= 1){
    
	entityDropItem(new ItemStack(mod_Flower.GuthanKey), 1);
