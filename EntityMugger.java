...
public class EntityMugger extends EntityMob
{
...
if(quickvar4 <= 1){entityDropItem(new ItemStack(mod_BlocksGalore.Mithaxe), 1);}
if(quickvar5 <= 1){entityDropItem(new ItemStack(mod_BlocksGalore.Mithsword), 1);}
if(quickvar6 <= 1){entityDropItem(new ItemStack(mod_BlocksGalore.MithHammer), 1);}
