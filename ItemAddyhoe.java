...
public class ItemAddyhoe extends Item
{
    protected EnumToolGalore theToolMaterial;

    public ItemAddyhoe(int par1, EnumToolGalore par2EnumToolMaterial)
    {
        super(par1);
    ...
    {
            if(itemID == mod_BlocksGalore.Addyhoe.itemID)
            {
            this.itemIcon = ir.registerIcon("Addyhoe");
            }
    }
}
