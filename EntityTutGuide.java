...
public class EntityTutGuide extends EntityMob
{
    private float moveSpeed;
	public EntityTutGuide(World par1World)
    {
        super(par1World);
        this.func_82163_bD();
        this.moveSpeed = 0.0F;
...
protected String getLivingSound()
    ...
    {
  	  if(!worldObj.isRemote) { 	ModLoader.getMinecraftInstance().thePlayer.addChatMessage("\u00a7EWelcome to the world of Scapecraft! Proceed through the tutorial to learn the basics of the game. Make sure to read the signs for more information and ask players for newbie help");
    ...
    public void func_82163_bD()
    {
    	 ...
    	 this.setCanPickUpLoot(this.rand.nextFloat() < equipmentDropChances[this.worldObj.difficultySetting]);
    	   if (this.getCurrentItemOrArmor(4) == null){
    		   ...
    		   this.setCurrentItemOrArmor(4, new ItemStack(mod_phat.rphatHelmet));
