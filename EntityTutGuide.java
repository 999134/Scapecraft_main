	...
	public boolean interact(EntityPlayer par1EntityPlayer) {
		if (!worldObj.isRemote) {
			ModLoader.getMinecraftInstance().thePlayer.addChatMessage(
					"\u00a7EWelcome to the world of Scapecraft! Proceed through the tutorial to learn the basics of the game. Make sure to read the signs for more information and ask players for newbie help");
		}
