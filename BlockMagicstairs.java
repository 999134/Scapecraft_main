...
public class BlockMagicstairs extends BlockStairs
{
    ...
    protected BlockMagicstairs(int par1, Block par2Block, int par3)
    {
        super(par1, stone ,0);
    ...
    {
        return par0 > 0 && Block.blocksList[par0] instanceof BlockMagicstairs;
    }
    ...
    public void registerIcons(IconRegister ir)
    {
            ...
            {
            this.blockIcon = ir.registerIcon("magicstairs");
            }
    }
}
