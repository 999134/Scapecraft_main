...
public class WorldGenYewtree extends WorldGenerator
{
        ...
        public boolean generate(World world, Random random, int i, int j, int k)
        {
                        ...
                        for(int i2 = i - byte0; i2 <= i + byte0 && flag; i2++)
                        {
                                for(int l2 = k - byte0; l2 <= k + byte0 && flag; l2++)
                                {
                                        if(i1 >= 0 && i1 < 256)
                                        {
                                                ...
                                                if(j3 != 0 && j3 != mod_YewTree.Yewleaf.blockID)
                                                {
                                                        flag = false;
                                                }
                                        } else
                ...
                for(int k1 = (j - 3) + l; k1 <= j + l; k1++)
                {
                        ...
                        for(int k3 = i - i3; k3 <= i + i3; k3++)
                        {
                                ...
                                for(int i4 = k - i3; i4 <= k + i3; i4++)
                                {
                                        ...
                                        {
                                                 setBlockAndMetadata(world, k3, k1, i4, mod_YewTree.Yewleaf.blockID, 0);
                                        }
                                }
                        }
                }
                ...
                for(int l1 = 0; l1 < l; l1++)
                {
                        ...
                        if(k2 == 0 || k2 == mod_YewTree.Yewleaf.blockID)
                        {
                                 setBlockAndMetadata(world, i, j + l1, k, mod_YewTree.Yewlog.blockID, 0);
                        }
                }
