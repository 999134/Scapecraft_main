...
public class ItemDBA extends ItemSword {
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		if (props.getEnergy() > 9900) {
			...
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX + 1, par3EntityPlayer.posY,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX - 1, par3EntityPlayer.posY,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY,
					par3EntityPlayer.posZ + 1, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY,
					par3EntityPlayer.posZ - 1, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY + 1,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX + 1, par3EntityPlayer.posY + 1,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX - 1, par3EntityPlayer.posY + 1,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY + 1,
			...
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY - 1,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY + 2,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX + 1, par3EntityPlayer.posY + 2,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX - 1, par3EntityPlayer.posY + 2,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY + 2,
			...
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY + 2,
					par3EntityPlayer.posZ - 1, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY + 3,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX + 1, par3EntityPlayer.posY + 3,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX - 1, par3EntityPlayer.posY + 3,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY + 3,
			...
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY + 2,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX + 2, par3EntityPlayer.posY + 2,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX - 2, par3EntityPlayer.posY + 2,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY + 2,
					par3EntityPlayer.posZ + 2, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY + 2,
					par3EntityPlayer.posZ - 2, 1.0D, 0.0D, 0.0D);
			par3EntityPlayer.worldObj.spawnParticle("reddust", par3EntityPlayer.posX, par3EntityPlayer.posY + 2,
					par3EntityPlayer.posZ, 1.0D, 0.0D, 0.0D);
			...
			par3EntityPlayer.addChatMessage("\u00a7EYou have " + String.valueOf(props.getEnergy() / 100)
					+ "%% Special Attack Energy, 100%% is needed");
		}
		return par1ItemStack;
