		...
		if (itemstack != null && itemstack.itemID == 266) {
			if (itemstack.stackSize-- == 1) {
				...
				par5EntityPlayer.addChatMessage(
						"\u00a7EKoschei the Deathless: You are brave to face me but now is your time to die");
				EntityKos1 entity = new EntityKos1(par1World);
				entity.setLocationAndAngles(par2, par3 + 1, par4, par1World.rand.nextFloat() * 360.0F, 0.0F);
