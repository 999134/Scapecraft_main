...
public class BlockAgilityBlock extends Block
{
    public BlockAgilityBlock(int i, int j)
    {
    ...
    {ExtendedPlayer.get(par5EntityPlayer).addAXp(1);ExtendedPlayer props = ExtendedPlayer.get(par5EntityPlayer);
