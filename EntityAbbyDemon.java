...
public class EntityAbbyDemon extends EntityMob {
	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		if (quickvar <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.Whip), 1);
			MinecraftServer.getServer().getConfigurationManager()
					.sendChatMsg((new ChatMessageComponent().addText("An Abby Demon dropped a whip!")));
		}
		if (quickvar1 <= 1) {
			entityDropItem(new ItemStack(mod_BlocksGalore.DragonScimmy), 1);
			MinecraftServer.getServer().getConfigurationManager()
					.sendChatMsg((new ChatMessageComponent().addText("An Abby Demon dropped a dragon scimmy!")));
		}
		if (quickvar3 <= 1) {
